...
function ready () {
    ...
    // Purchase button should remove all items from cart
...
function addToCartClicked(event) {
    ...
    // Need to add image, price, and name
...
function addItemToCart(title, price, imageSrc) {
    ...
    // This code prevents same item being added twice to cart
    ...
    // Add event listener so that the remove button is also loaded as it wasn't initially
